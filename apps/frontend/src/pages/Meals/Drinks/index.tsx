...
const drinkRecipes: Recipe[] = [
  ...
  {
    title: 'Lemon Mint Iced Tea',
    description: 'Cooling & Refreshing',
    time: '10 minutes',
    calories: 50,
    imageUrl:
...
const Drinks: React.FC = () => {
  const [activeFilter, setActiveFilter] = useState<string>('Đồ uống');
    ...
    <div className="min-h-screen">
      <main className="container mx-auto">
        <div className="relative text-center mt-20">
          <h2 className="text-4xl font-bold mb-2">Các món đồ uống mát lành</h2>
          <p className="text-gray-600 text-lg mb-8">
            Khám phá những loại đồ uống ngon và bổ dưỡng
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mt-8">
          {drinkRecipes.map((recipe, index) => (
            <div key={index} className="relative pt-20">
              <div
                className="bg-gradient-to-b from-blue-50 to-white rounded-lg shadow-lg hover:scale-105 transition-all ease-in-out"
                style={{ height: '400px' }}
              >

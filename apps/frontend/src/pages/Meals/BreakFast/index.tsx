...
const BreakFast: React.FC = () => {
  return (
    <div className="bg-gray-50 min-h-screen">
      <main className="container mr-2 ml-2 py-16 px-4 relative">
      <div className="relative h-[400px] mb-24 rounded-xl overflow-hidden">
          {/* Background container */}
          <div className="absolute inset-0">
            <img
              src="https://noidiennaupho.com/wp-content/uploads/2024/07/Pho-bo-to-hieu.jpg"
          ...
          <div className="relative h-full flex flex-col items-center justify-center">
            <h2 className="text-5xl font-semibold text-white">Bữa sáng</h2>
            <h3 className="pt-2 text-xl font-serif text-white">
              Bắt đầu ngày mới với năng lượng và gia vị!
            </h3>
          </div>
        </div>


        <div className=" pt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
